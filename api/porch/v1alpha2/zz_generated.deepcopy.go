...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PackageCloneSpec) DeepCopyInto(out *PackageCloneSpec) {
	*out = *in
	if in.CloneFrom != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PackageCloneSpec.
func (in *PackageCloneSpec) DeepCopy() *PackageCloneSpec {
	if in == nil {
		return nil
	}
